				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="ml-sm-3">
											<input type="text" name="member_code" id="member_code"
												...
												value="${sessionScope.member_code}" readonly>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-4">
									<a href="./Mainpage.jh" class="btn btn-primary btn-block">
										메인 페이지로 이동하기 </a>
								</div>
								<div class="col-md-4">
									<a href="./MemberUpdateView.jh"
										class="btn btn-warning btn-block"> 회원정보 수정 </a>
								</div>
							</div>
						</div>
					</div>
