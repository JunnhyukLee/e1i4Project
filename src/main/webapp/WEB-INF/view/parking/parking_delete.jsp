...
<i class="fas fa-user-plus mr-sm-1"></i>${param.parking_code}번의 주차장 정보를 삭제하시겠습니까?</div>
</div>

<nav class="navbar justify-content-end">
<button onclick="location.href = './ParkingDeleteProcess.hj?parking_code=${param.parking_code}'" class="btn btn-outline-primary mr-sm-1">
