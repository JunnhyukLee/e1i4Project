...
<td>
<a href="./ParkingSelectDetail.hj?parking_code=${arrayList.parking_code}">상세 보기</a>
<a href="./RecordsSelectParking.hw?parking_code=${arrayList.parking_code}&parking_name=${arrayList.parking_name}">주차 기록 보기</a>
</td>
</tr>
</c:forEach>
