        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn-warning" href="./NoticeSelect.so">공지 사항</a>
                    </li>
                    <c:if test="${member_rating eq 'admin'}">
                     ...
                     <li class="nav-item">
                        <a class="nav-link btn-link" href="./Mainpage.jh">메인 페이지</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach var="arrayList" items="${arrayList}">
                                <tr class="text-center">
                                    ...
                                    <td><a href="./NoticeSelectEventDetail.so?notice_code=${arrayList.notice_code}">${arrayList.notice_title}</a></td>
