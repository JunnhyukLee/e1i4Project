...
public class RecordsSelectDetailParkingController implements Controller {
	
	private static final Log log = LogFactory.getLog(RecordsSelectDetailParkingController.class);
	...
	public HandlerAdapter execute(HttpServletRequest request, HttpServletResponse response) {
		...
		handlerAdapter.setPath("/WEB-INF/view/records/records_select_detail_parking.jsp");
